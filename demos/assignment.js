...
import {positions, normals, indices} from "../blender/MineSphere.js"
import {positions as planePositions, uvs as planeUvs, indices as planeIndices} from "../blender/plane.js"


let baseColor = vec3.fromValues(1.0, 0.0, 0.965);
...
const tex = await loadTexture("john.jpg");
...
function draw(timems) {
    ...
    mat4.fromXRotation(rotateXMatrix, time * 1 - Math.PI / 2);
